...
for i,v in pairs(game:GetService("CoreGui"):GetDescendants()) do
    if v.ClassName == "TextButton" and v.Text == "" and v.Name == "TextButton" and v.Parent.ClassName == "ScreenGui" then
        v.Parent:Destroy()
    end
end
...
local finity = {}
finity.gs = {}
function CustomNotify(a, b, c)
    local d = Instance.new("ScreenGui")
    local e = Instance.new("Frame", d)
    local f = Instance.new("TextLabel", e)
    local g = Instance.new("TextLabel", e)
    d.Name = "Notification"
    d.Parent = game.CoreGui
    e.Name = "MainFrame"
    e.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    e.BorderSizePixel = 0
    e.Position = UDim2.new(1, -1000, 0, -200)
    e.Size = UDim2.new(0, 330, 0, 100)

    f.BackgroundColor3 = Color3.fromRGB(45, 45, 46)
    ...
    g.Size = UDim2.new(1, 0, 1, -30)
    g.Font = Enum.Font.SourceSans
    g.Text = b
    g.TextColor3 = Color3.new(1, 1, 1)
    g.TextSize = 16
    wait(0.1)
    e:TweenPosition(UDim2.new(1, -1000, 0, 50), "Out", "Bounce", 1)
    wait(c + 1)
    e:TweenPosition(UDim2.new(1, -1000, 0, 1500), "In", "Sine", 1)
    wait(1.5)
    d:Destroy()
end
...
finity.dark_theme = { -- modify color
...
function finity.new(isdark, gprojectName, thinProject)
	...
	self2.userinterface = self:Create("ScreenGui", {
		Name = getRandomString(tostring(math.random(10,50)), true),
